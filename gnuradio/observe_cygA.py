...
science_target = Source(name = 'CygA',
                        coord = SkyCoord.from_name('Cygnus A'))
phase_calibrators = [Source(name = '3C345',
                            coord = SkyCoord.from_name('3C345')),
                     Source(name = '2202+422',
                            coord = SkyCoord(Angle('22h02m43.291377s'),
                                             Angle('42d16m39.979940s')))]
obs_freq = 4900
...
def choose_calibrator():
    ...
    # hack to avoid choosing too low calibrators
    alt_calibrators[alt_calibrators <= 18] = 1000
...
def setup_array():
    ...
    move_ant_group(antennas_all_usrps, 'none', 'atagr')
...
def main():
    ...
    while True:
        ...
        for run in range(science_runs):
            ...
            tb.do_run(baselines_all, science_target, science_scan_len)
